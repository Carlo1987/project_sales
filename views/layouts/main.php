                   ...
                   <section>
                       ...
                       <div class="products">
                           ...
                           <div class="arrows left">
                               <img src="assets/img/double_arrow_left.png" alt="arrow">
                           </div>
                           ...
                           <div class="products_boxe">
                               <?php while ($prod = $products->fetch_object()) :
                                   ...
                                   <div class="product list_index">
                                       <a href="index.php?controller=Products_controller&action=product_one&id=<?= $prod->id ?>">
                                           ...
                                           <img src="assets/img/products/<?= $type->name ?>/<?= $prod->image ?>" alt="product">
                           ...
                           <div class="arrows right">
                               <img src="assets/img/double_arrow_right.png" alt="arrow">
                           </div>
               ...
               <?php $types_class = new Type();
                ...
                while ($type = $types->fetch_object()) :  ?>
                   <div class="query_type">
                       <a href="index.php?controller=Products_controller&action=products_for_type&id=<?= $type->id ?>">
                           ...
                           <div style="width: 85%; height: 85%;">
                               <?php $products_class = new Product();
                                ...
                                if ($number_products->num_rows > 0) :  ?>
                                   <img src="assets/img/products/<?= $type->name ?>/<?= $product->image ?>" alt="product">
                               <?php else : ?>
                                   <img src="assets/img/insieme_vuoto.png" alt="product">
                               <?php endif; ?>
                           </div>
                       </a>
                   </div>
