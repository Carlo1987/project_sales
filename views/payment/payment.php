...
<div class="content_payment">
    ...
    <form class="payment card_debit" method="POST" action="index.php?controller=Payment_controller&action=pay">
        <div class="methods_payments">
            <p class="type_cards">Carte accettate :</p>
            <article> <img src="assets/img/payment/Visa-Logo.png" alt="image_card"> </article>
            <article> <img src="assets/img/payment/mastercard_logo.png" alt="image_card"> </article>
            <article> <img src="assets/img/payment/maestro_logo.png" alt="image_card"> </article>
            <article> <img src="assets/img/payment/carta_credito.png" alt="image_card"> </article>
        </div>
    ...
    <form class="payment bank" method="POST" action="index.php?controller=Payment_controller&action=pay">
    ...
    <?php if(isset($_SESSION['error_payment'])){  echo $_SESSION['error_payment'];  } 
    
    Utils::delete_errors_payment();   ?>
