        ...
        while ($product = $products->fetch_object()) :   ?>
            <div class="result_row">
                ...
                <div style="display: flex; align-items:center; gap:5px;">
                    ...
                    <div> <img src="assets/img/products/<?= $product->type ?>/<?= $product->image ?>" alt="img_prodotto"> </div>

                    <div style="width: 100%;">
                        <a href="index.php?controller=Products_controller&action=product_one&id=<?= $product->id ?>">
                            <?= $product->name ?>
                        </a>
                    </div>
